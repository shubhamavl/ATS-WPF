...
A professional Windows WPF application for real-time weight monitoring and calibration of STM32-based two-wheeler systems via CAN bus communication.
...
3. **Run** `ATS_WPF.exe` - **No installation required!**
...
**Compatibility**: ATS Two-Wheeler System v0.1  
