...
namespace ATS.CAN.Engine.Services
{
    public class CANMessageProcessor
    {
        ...
        public const uint CAN_MSG_ID_TOTAL_RAW_DATA = 0x200;       // Main/Left/Right/Total Raw Data
        public const uint CAN_MSG_ID_START_STREAM = 0x040;         // Start
        public const uint CAN_MSG_ID_SELECT_LMV_STREAM = 0x048;    // Specific LMV Stream Selection (Data: 0=Left, 1=Right)
        ...
        public static bool IsSystemMessage(uint canId)
        {
            switch (canId)
            {
                ...
                case CAN_MSG_ID_SELECT_LMV_STREAM:
